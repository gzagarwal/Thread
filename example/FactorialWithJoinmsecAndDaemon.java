...
public class FactorialWithJoinmsecAndDaemon {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i : streamList) {
            ...
            sss.setDaemon(true);
            sss.start();
           // sss.join();// With Join it will execute Records .
           ...
           // List<Integer> streamList = Stream.of(new Integer[]{11000000,20, 3435, 40, 10, 4, 6, 9}).collect(Collectors.toList());
            ...
            //SO to terminate the threads we have two options , Either Interrupt or make the thread as daemon.
        }
